...
#GET OFF MY PI GET OFF MY PI GET OFF MY PI
import random, copy, sys, pygame
from pygame.locals import *

BOARDWIDTH =  7 # how many spaces wide the board is, changed for more spaces available
BOARDHEIGHT = 5 # how many spaces tall the board is, changed height for more challenging game
assert BOARDWIDTH >= 7 and BOARDHEIGHT >= 5, 'Board must be at least 4x4.'

DIFFICULTY = 2 # how many moves to look ahead. (>2 is usually too much)

SPACESIZE = 50 # size of the tokens and individual board spaces in pixels
               # changed to make game more difficult 

FPS = 40 # frames per second to update the screen, changed from 30 for better visual experience
